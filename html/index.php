...
<head>
    ...
    <style>
		body { margin:0;padding:0;background:#f7f7f7; font: 13px Ubuntu,sans-serif; color:#333; }
        #wrap { margin: 25px auto;width:1000px;background:#fff;border:8px solid #acb5b4;}
        ...
        a {color:inherit; }
        a:hover {background-color:#e8e8e8;color:#e80;}
